...
import { initQueryKey } from '@/utils/queryKet';
...
export const EventList = async () => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/hp/api/event?clubCode=${process.env.NEXT_PUBLIC_G_CODE}&page=0&size=3&post=true`, {
    cache: "no-store",
  })
